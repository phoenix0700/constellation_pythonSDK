...
class GraphQLField:
    ...
    def to_string(self, indent: int = 0) -> str:
        ...
        field_str = f"{spaces}{self.alias}: {self.name}" if self.alias else f"{spaces}{self.name}"
...
class QueryBuilder:
    ...
    def metagraphs(self, filters: Optional[Dict[str, Any]] = None) -> 'MetagraphsQueryBuilder':
        """
...
class AccountQueryBuilder:
    ...
    def with_transactions(self, limit: Optional[int] = None, offset: Optional[int] = None) -> 'AccountQueryBuilder':
        """
...
class SubscriptionBuilder:
    ...
    def transaction_updates(self, addresses: Optional[List[str]] = None) -> 'SubscriptionBuilder':
...
def build_account_query(address: str, include_transactions: bool = True, include_balances: bool = True) -> str:
    """
...
def build_metagraph_query(metagraph_id: str, include_holders: bool = True, include_transactions: bool = True) -> str:
    """
