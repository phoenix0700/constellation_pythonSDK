...
class NetworkConfig:
    ...
    def __post_init__(self):
        ...
        if self.timeout <= 0:
            raise ConfigurationError("Timeout must be positive", "timeout", self.timeout)
        if self.max_retries < 0:
            raise ConfigurationError("Max retries cannot be negative", "max_retries", self.max_retries)
...
def create_custom_config(be_url: str, l0_url: str, l1_url: str, 
                        network_version: str = "2.0", **kwargs) -> NetworkConfig:
