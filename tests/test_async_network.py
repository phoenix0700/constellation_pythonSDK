...
try:
    ...
    from constellation_sdk.exceptions import NetworkError, TimeoutError, HTTPError
...
pytestmark = pytest.mark.skipif(
    not ASYNC_AVAILABLE,
    reason="aiohttp not available, async components disabled"
)
...
class TestAsyncHTTPClient:
    ...
    async def test_session_creation(self, mock_session_class):
        ...
        assert call_args.kwargs['headers']['User-Agent'] == 'Constellation-Python-SDK/1.2.0'
