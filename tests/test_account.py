...
class TestTransactionSigning:
    ...
    def test_dag_transaction_signing(self, alice_account, valid_dag_transaction_data, signature_validator):
    ...
    def test_genesis_transaction_signing(self, alice_account, bob_account, signature_validator):
        ...
        assert signature_validator(signed_tx)
        assert 'parent' not in signed_tx['value']  # Genesis transactions don't include parent
    
    def test_regular_transaction_with_parent(self, alice_account, bob_account, signature_validator):
    ...
    def test_metagraph_token_transaction_signing(self, alice_account, valid_token_transfer_data, signature_validator):
        ...
        assert signed_tx['value']['metagraph_id'] == valid_token_transfer_data['metagraph_id']
        assert signed_tx['value']['amount'] == valid_token_transfer_data['amount']
    
    def test_metagraph_data_transaction_signing(self, alice_account, valid_data_submission_data, signature_validator):
        ...
        assert signed_tx['value']['metagraph_id'] == valid_data_submission_data['metagraph_id']
    ...
    def test_signature_determinism(self, known_account, valid_dag_transaction_data):
        ...
        assert signed_tx1['proofs'][0]['signature'] == signed_tx2['proofs'][0]['signature']
    
    def test_different_accounts_different_signatures(self, alice_account, bob_account, valid_dag_transaction_data):
        ...
        assert alice_signed['proofs'][0]['signature'] != bob_signed['proofs'][0]['signature']
