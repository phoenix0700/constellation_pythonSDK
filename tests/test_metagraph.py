...
class TestMetagraphClientInitialization:
    ...
    def test_client_creation_mainnet(self):
        ...
        assert 'mainnet' in client.base_url.lower() or 'constellation.io' in client.base_url
...
class TestMetagraphBalanceOperations:
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_get_metagraph_balance_success(self, mock_get, alice_account, test_metagraph_id):
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_get_metagraph_balance_validation_errors(self, alice_account, test_metagraph_id, invalid_dag_addresses):
...
class TestMetagraphTransactionHistory:
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_get_metagraph_transactions_success(self, mock_get, alice_account, test_metagraph_id):
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_get_metagraph_transactions_with_limit(self, mock_get, alice_account, test_metagraph_id):
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_get_metagraph_transactions_empty_history(self, mock_get, alice_account, test_metagraph_id):
...
class TestMetagraphErrorHandling:
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_unexpected_response_structure(self, mock_get, alice_account, test_metagraph_id):
...
class TestMetagraphPerformance:
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_concurrent_balance_requests(self, mock_get, test_accounts, test_metagraph_id):
...
class TestMetagraphEdgeCases:
    ...
    @patch('constellation_sdk.metagraph.requests.get')
    def test_very_large_metagraph_balance(self, mock_get, alice_account, test_metagraph_id):
