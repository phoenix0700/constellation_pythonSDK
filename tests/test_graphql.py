...
class TestGraphQLClient:
    ...
    async def test_execute_query_async(self):
        ...
        with patch.object(self.client, '_execute_via_rest_translation_async') as mock_execute:
            mock_execute.return_value = {"network": {"status": "active"}}
    ...
    def test_batch_execute(self):
        ...
        queries = [
            ...
            GraphQLQuery(query="query { account { balance } }", variables={"address": self.valid_address})
        ]
    ...
    def test_rest_translation_network_query(self):
        ...
        with patch.object(self.client.network_client, 'get_node_info') as mock_info:
            with patch.object(self.client.network_client, 'get_cluster_info') as mock_cluster:
...
class TestQueryBuilder:
    ...
    def test_metagraph_query_builder(self):
        ...
        query = (self.builder
                 .metagraph(self.valid_metagraph_id)
                 .with_info()
                 .with_supply_info()
    ...
    def test_query_with_variables(self):
        ...
        query = (self.builder
                 .add_variable("address", self.valid_address)
...
class TestSubscriptionBuilder:
    ...
    def test_transaction_subscription(self):
        ...
        subscription = (self.builder
                       .transaction_updates([self.valid_address])
                       .build())
    ...
    def test_balance_subscription(self):
        ...
        subscription = (self.builder
                       .balance_updates([self.valid_address])
                       .build())
...
class TestGraphQLIntegration:
    ...
    def test_execute_query_convenience(self):
        ...
        with patch('constellation_sdk.graphql.GraphQLClient') as mock_client_class:
            mock_client = Mock()
            mock_client.execute.return_value = GraphQLResponse(data={"network": {"status": "active"}})
    ...
    async def test_execute_query_async_convenience(self):
        ...
        with patch('constellation_sdk.graphql.GraphQLClient') as mock_client_class:
            mock_client = Mock()
            mock_client.execute_async = AsyncMock(return_value=GraphQLResponse(data={"network": {"status": "active"}}))
    ...
    def test_get_metagraph_overview_convenience(self):
        ...
        with patch('constellation_sdk.graphql.execute_query') as mock_execute:
            mock_execute.return_value = GraphQLResponse(
                data={"metagraph": {"id": self.valid_metagraph_id, "name": "Test Metagraph"}}
            )
